...
## Purpose
**Netdata:** Provides real time system metrics for devices in the home lab. The live metrics are avaliable online via the netdata cloud website.
...
After deployemnt, monitors were added through the Uptime Kuma web UI for each lab service.
...
## Current Status
- Netdata's container is running and collecting host metrics
- Uptime Kuma container running with monitors configured for core lab services.

## Known Limitations / Future Work
- Firewall metrics are not currently visible in netdata
- No monitoring of health of lab switch
- NetFlow / traffic analysis not yet configured - pfSene supports NetFlow export, planned for the future
