...
## Why Self Hosted
A previous instance that was costed on a netbox cloud trial expired and resulted in data loss. This deployment uses explicit Docker volume mounts and scheduled backups to ensure persistence.
